...
Neuigkeiten is a WordPress Starter Theme for Developers.
...
https://github.com/pontikis/neuigkeiten

## Demo

https://neuigkeiten.pontikis.net

## How to use it

In order to create your own theme with Neuigkeiten:
...
Neuigkeiten supports localization (using gettext). Currently, Greek language is also available.
...
If you want to experiment with a child theme, find Neuigkeiten Child Theme at https://github.com/pontikis/neuigkeiten-child-theme
